...
<body>
    ...
    <main>
        <div class="container">
            ...
            <div class="login-box">
                ...
                <div class="footer">
                    <a href="<?= BASE_URL ?>index.php?url=login" class="d-block mt-3 text-success return">Volver al inicio de sesión</a>
                </div>
            </div>
        </div>
    </main>
    ...
    <script>
        document.getElementById("form-recuperar").addEventListener("submit", function(event) {
            ...
            fetch("<?= BASE_URL ?>index.php?url=recuperar/enviarCorreo", {
                method: "POST",
