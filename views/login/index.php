<?php
    ...
    require_once __DIR__ . '/../../config.php'; // Ajusta según tu estructura real
...
<body>
    ...
    <div class="login-container">
        ...
        <form action="<?= BASE_URL ?>index.php?url=login/login" method="POST">
        ...
        <a href="<?= BASE_URL ?>index.php?url=recuperar/mostrarFormulario" class="d-block mt-3 text-success">Recuperar contraseña</a>
