...
<body>
    ...
    <main class="container my-4">
        <section class="create-ambiente" id="section-create-ambiente">
            <form action="createTablero" action="guardarTablero.php" method="POST">
    ...
    <script>
        document.querySelector('form').addEventListener('submit', function(event) {
            ...
            fetch('createTablero', {  // Aquí se está enviando la solicitud al controlador
                method: 'POST',
                body: formData
            })
            ...
            .then(data => {
                if (data.success) {
                    ...
                    Swal.fire({
                        ...
                        window.location.href = '../tableros';  // Redirigir a la lista de computadores
                    });
                } else {
                    ...
                    Swal.fire({
                        ...
                        confirmButtonText: 'OK',
                        confirmButtonClass: 'custom-btn-red'  // Clase personalizada para el botón
                    });
                }
            })
            .catch(error => {
