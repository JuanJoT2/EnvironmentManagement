        ...
        public function enviarCorreo() {
            ...
            if ($usuario) {
                ...
                try {
                    ...
                    $mail->SMTPAuth = true;
                    $mail->Username = 'gestionambientes0@gmail.com';
                    $mail->Password = 'pgonyutgtwuvvmpw';
                    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
                    $mail->Port = 587;
        
                    $mail->setFrom('gestionambientes0@gmail.com', 'Soporte Gestion de Ambientes');
                    ...
                    <html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office">
                        ...
                        <body>
                            <div class="container">
                                ...
                                <a href="https://gestiondeambientescdm.com/" class="button">Iniciar Sesión</a>
