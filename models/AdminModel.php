...
include_once 'config/db.php';
    ...
    class AdminModel {  
        ...
        public function existeComputador($serial, $placaInventario) {
            $conn = Database::connect();
            $sql = "SELECT * FROM t_computadores WHERE Serial = '$serial' OR Placa_inventario = '$placaInventario'";
        ...
        // Apartado de Modelo para Historial de Reportes
}
